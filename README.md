...
## :thought_balloon: О проекте <a name="#about"></a>
...
📦*yourfolder*
 ...
 ┗ 🐍 manager.py
```
<center><font size="2" style="text-align:center">Более подробно про каждый из каталогов будет рассказано далее</font></center>
<br>
...
```json
{
    //Стандартная группа. нельзя удалять
    "group": "default",

    // Список слов входящих в группу
    "words": {
        // Название слова, на которое бот реагирует.
        // Может содержать любые символы.
        // Для файла _default.json "main" обязательное
        // системное значение.
        "main": {
            // Фразы для реакции.
            "templates": [ "бот" ],
            // Варианты ответа разбитые по редкости.
            "answer": {
                "common": ["Я бот"],
            ...
            // Ключ клавиатуры, которую нужно
            // отправить для данного слова.
            "keyboard": "default"
        },
        ...
    }
...
```console
(env) C:\Users\user\Desktop\shablbot>py - shablbot --init
